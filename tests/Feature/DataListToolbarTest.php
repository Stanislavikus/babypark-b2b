...
class DataListToolbarTest extends TestCase
{
    ...
    #[Test]
    public function data_list_toolbar_uses_shared_in_button_badges_for_desktop_counts(): void
    {
        ...
        $this->assertStringContainsString('class="bp-toolbar-count-trigger"', $toolbar);
        $this->assertStringContainsString('class="bp-toolbar-count-trigger"', $fieldMatrix);
