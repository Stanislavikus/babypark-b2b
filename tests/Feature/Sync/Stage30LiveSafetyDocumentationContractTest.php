...
class Stage30LiveSafetyDocumentationContractTest extends TestCase
{
    ...
    #[Test]
    public function run_sync_live_is_implemented_in_stage_3a_catalogue(): void
    {
        $e8 = $this->e8Section();
    ...
    public function stale_recovery_must_prevent_overlapping_consequential_writers(): void
    {
        ...
        $this->assertStringContainsString('stale active-run lease/recovery exists for `sync_runs`', $section);
    }
    ...
    public function stage_3a_through_3e_sequence_is_documented(): void
    {
        ...
        $this->assertStringContainsString('**Stage 3C–3E — Live Engine orchestration & merchant exposure**', $gaps);
    }
