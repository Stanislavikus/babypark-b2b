...
class ConnectorDiscoveryRunTranslationTest extends TestCase
{
    #[Test]
    public function every_producible_message_key_exists_in_all_supported_locales(): void
    {
        ...
        $messageKeys = array_unique([
            ...array_map(
                static fn (ConnectorDiscoveryRunLifecycleErrorCode $case) => $case->messageKey(),
                ConnectorDiscoveryRunLifecycleErrorCode::cases(),
            ),
            ...array_map(
                static fn (ConnectorDiscoveryRunErrorCode $case) => $case->messageKey(),
