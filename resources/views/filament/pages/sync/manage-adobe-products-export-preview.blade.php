...
>
  <div class="space-y-4" @if ($pollActive || $livePollActive) wire:poll.5s="refreshPresentation" @endif>
    <x-filament::section>
    ...
    @if ($previewSectionVisible)
      <div class="space-y-4" data-testid="sync-preview-section">
    ...
    @include('filament.pages.sync.partials.sync-live-section')
  </div>
</x-filament-panels::page>
