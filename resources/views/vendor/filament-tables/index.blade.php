        ...
        <div class="fi-ta-main">
            ...
            >
                ...
                >
                    ...
                    {{-- Toolbar layout customized: search is a direct flex-1 child (not inside the filters/column-manager group). --}}
                    ...
                    @if ($hasFiltersTrigger || $hasColumnManager)
                        <div class="fi-ta-header-toolbar-actions ms-auto flex shrink-0 items-center gap-x-3">
                                @if ($hasFiltersDialog)
