    ...
    <x-filament-tables::container>
        ...
        >
            ...
            <div
                ...
                {{-- Toolbar layout customized: search is a direct flex-1 child (not inside ms-auto). --}}
                class="fi-ta-header-toolbar flex items-center justify-between gap-x-4 py-3"
            >
                ...
                @if ($isGlobalSearchVisible)
                    <div class="fi-ta-header-toolbar-search min-w-0 flex-1">
                ...
                @if ($hasFiltersDialog || $hasColumnToggleDropdown)
                    <div class="ms-auto flex shrink-0 items-center gap-x-4 px-4 sm:px-6">
                        @if ($hasFiltersDialog)
