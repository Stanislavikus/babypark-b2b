@if ($this instanceof \Filament\Actions\Contracts\HasActions && (! $this->hasActionsModalRendered))
    <form novalidate wire:submit.prevent="callMountedAction">
        @php
...
@if ($this instanceof \Filament\Tables\Contracts\HasTable && (! $this->hasTableModalRendered))
    <form novalidate wire:submit.prevent="callMountedTableAction">
        @php
    ...
    <form novalidate wire:submit.prevent="callMountedTableBulkAction">
        @php
...
@if ($this instanceof \Filament\Infolists\Contracts\HasInfolists && (! $this->hasInfolistsModalRendered))
    <form novalidate wire:submit.prevent="callMountedInfolistAction">
        @php
...
@if (! $this->hasFormsModalRendered)
    ...
    <form novalidate wire:submit.prevent="callMountedFormComponentAction">
        <x-filament::modal
            :alignment="$action?->getModalAlignment()"
            :autofocus="$action?->isModalAutofocused()"
            :close-button="$action?->hasModalCloseButton()"
