<a href="#" class="relative inline-flex items-center text-gray-500 hover:text-primary-600 transition-colors" title="Кошик">
    ...
    @if($count > 0)
        <span class="absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-primary-600 text-[10px] font-bold text-white leading-none">
            {{ $count > 99 ? '99+' : $count }}
        </span>
    @endif
</a>
