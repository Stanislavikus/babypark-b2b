...
| **Stage 3C — Adobe Configurable Live** | **Done (internal)** — deterministic parent SKU for future atomic create path; existing-parent merchant SKU links clarified by Stop-and-Amend |
