...
| **Stage 3E-R2b-1 — Merchant ENTITY TRUST backend** | **Done (internal)** — review/confirm services, link readiness projector, candidate discovery + Safe Sync verification, encrypted review envelope, configurable-family atomic persistence; explicit relink backend semantics; zero Magento consequential writes; merchant Filament/Livewire UI pending R2b-2 |
