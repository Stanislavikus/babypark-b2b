...
If required, use a new snapshot envelope version only for snapshots that contain
this additive `execution_target` block. Existing Export snapshot semantics and
