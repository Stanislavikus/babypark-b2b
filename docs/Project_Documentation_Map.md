...
- `docs/reviews/PRODUCT_WORKBENCH_VISUAL_UX_CONTRACT_2026_09_22.md` — **[Resolved — 2026-09-22]** merchant-facing Workbench visual/interaction contract. Supersedes the three-tab prototype target: top-level `Огляд | Публікація`, correspondence inside Overview, Focus Mode + local filter rail, `Стан даних`/readiness/problems separation, AI-ready field foundation, and Master-Product-only creation direction.
