...
- `docs/reviews/PRODUCT_WORKBENCH_STRUCTURAL_CONTRACT_FREEZE_CANDIDATE_2026_09_21.md` — exact A+B structural freeze candidate; not [Resolved] until explicit product-owner approval. Contains final Magento row-universe contract, default+sparse override classification semantics, Projection V2 boundary, planner migration boundary, and Preview/Live determinism rules.
