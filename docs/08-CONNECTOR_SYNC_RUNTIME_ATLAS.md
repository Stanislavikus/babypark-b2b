...
| `run_sync_live` permission | RESOLVED — NOT IMPLEMENTED | Core | *(absent)* | none | `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → Live Safety, Identity & First-Live Contract (Stage 3-0) | platform-reusable |
| Stale active-run recovery | RESOLVED — NOT IMPLEMENTED | Connector | *(absent)* | none | `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → Stage 3-0 stale active-run safety | platform-reusable |
| `SyncLiveAdmissionService` | RESOLVED — NOT IMPLEMENTED | Connector | *(absent)* | none | `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → Stage 3-0 Preview→Live trust | platform-reusable |
| Live execution job shell (`tries = 1`) | CONFIRMED ABSENT | Connector | *(absent)* | none | `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → Stage 3-0 stale active-run safety | platform-reusable |
...
| ExternalRecordLink | CONFIRMED ABSENT | Connector | class does not exist (`tests/Feature/Sync/SyncRunPersistenceFoundationTest.php` asserts absence); normative structure frozen Stage 3-0; runtime deferred to Stage 3A | none | `tests/Feature/Sync/SyncRunPersistenceFoundationTest.php`; `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → E9 / Stage 3-0 ExternalRecordLink | platform-reusable / family-hypothesis |
| Live execution | CONFIRMED ABSENT | Connector | *(absent)* | none | `tests/Feature/Sync/Stage30LiveSafetyDocumentationContractTest.php`; `tests/Feature/Sync/PreviewSyncExecutionFoundationDocumentationContractTest.php` | `docs/03-DOMAIN_MODEL.md` → Stage 3-0 / Stage 3A–3E; merchant consequential exposure gated on `ConnectorSyncOperationSupport(Products, Export, Live) === true` until Stage 3E flip | connector-owned transport; platform-reusable outcomes |
