...
| SyncConfiguration connector execution configuration | IMPLEMENTED | Connector | `app/Support/Sync/ConnectorExecutionConfiguration.php`; `app/Models/SyncConfiguration.php` | `sync_configurations.connector_execution_configuration` | `tests/Feature/Sync/FieldOptionMappingTest.php`; `tests/Feature/Sync/SyncPreviewAdmissionTest.php` | `docs/03-DOMAIN_MODEL.md` → E5 Adobe attribute-set ownership | connector-owned semantics; platform-reusable persistence |
...
| Adobe Product Export metadata reader | IMPLEMENTED | Connector | `app/Support/Connectors/AdobePaaS/AdobeProductExportMetadataReader.php` | none (read-only HTTP seam) | `tests/Feature/Sync/SyncPreviewExecutionTest.php` | `docs/03-DOMAIN_MODEL.md` → Magento V1 Preview metadata | connector-owned |
